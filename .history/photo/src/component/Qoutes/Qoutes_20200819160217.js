  ...
  return (
    <div className="quotes__container">
      <div className="photo__quotes">
        ...
        <h4>
          "A lot of photographers think that if they buy a better camera they'll be able to take better photographs. A better camera won't do a thing for you if you do"
        </h4>
        <span className="quoteswriter"> - Percy W. Harris</span>
      </div>
      <div></div>
