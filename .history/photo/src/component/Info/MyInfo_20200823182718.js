      ...
      <div className="photo__container">
        ...
        <h3>
          <p className="about__container">
            ...
            years now. California has such wonderful and vast place to venture and endure and envy many beautiful and different landscape from lush green to snow-capped and mountains and 
          </p>
        </h3>
      </div>
    </div>
