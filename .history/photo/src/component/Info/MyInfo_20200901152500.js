    ...
    <div className="info__container">
      ...
      <div className="photo__container">
        <img
          ...
          alt="avatar"
        />
        <h3 style={{paddingTop: '1em'}}>Tsering Kalden</h3>

        <h3 style={{color: 'blue'}}>A Passionate and Avid Photographer</h3>
        ...
        <div className="about__me">
          ...
          <h3>
            ...
            <p className="about__container">
              ...
              falls in Sierra Nevada Mountain Ranges. Its such a unique state.
            </p>
          </h3>
        </div>
