  ...
  return (
    <div className="quotes__container">
      <div className="photo__quotes">
        ...
        <span className="quotes__writer"> - Percy W. Harris</span>
        <h4 className="quotes__line">“One doesn’t stop seeing. One doesn’t stop framing. It doesn’t turn off and turn on. It’s on all the time.”</h4>
        <span className="quotes__writer"></span>
      </div>
      <div></div>
    </div>
  );
